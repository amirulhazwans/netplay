...
import 'package:net_play/score/config/constants.dart';
import 'package:net_play/score/config/session.dart';
import 'package:net_play/score/providers/team_provider.dart';
import 'package:flutter/material.dart';
import 'package:flutter_riverpod/flutter_riverpod.dart';
import 'package:net_play/score/providers/theme_provider.dart';
import 'package:net_play/score/screens/create_match_screen.dart';
            ...
            children: <Widget>[
              ...
              Row(
                ...
                children: [
                  ElevatedButton(
                    onPressed: () {
                      // Handle the create match action
                      ref.read(teamProvider.notifier).addTeams(playerNames);
                      Navigator.of(context).push(
                        MaterialPageRoute(
                          builder: (context) => PossibleMatches(),
                        ),
                      );
                    },
                  ...
                  ElevatedButton(
                    onPressed: () {
                      // Handle the delete all teams action
                      _deleteAllPlayers();
                    },
